      ...
      >
        {showToast && (
          <Animated.View
            entering={FadeInUp}
            exiting={FadeOutUp}
            className="absolute top-12 z-50 w-full self-center px-6"
          >
            <View
        ...
        <View className="flex-row items-center justify-between border-black/10 border-b px-6 py-4 dark:border-white/10">
          <Text className="font-bold text-gray-900 text-lg dark:text-white">
            Detalles de la sesión
          </Text>
          <Pressable onPress={onClose} className="-mr-2 p-2 active:opacity-70">
            <Ionicons name="close" size={24} color={theme.colors.iconAccent} />
          </Pressable>
        </View>
